...
class BlockImprinter(id: Int) extends Block(id, Material.rock) with HasTE[TileImprinter] with BlockCoverable[TileImprinter] with BreakableInventoryBlock with BlockGuiWrenchable {
