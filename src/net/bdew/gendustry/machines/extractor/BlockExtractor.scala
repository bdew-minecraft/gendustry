...
object BlockExtractor extends Block(Material.rock) with HasTE[TileExtractor] with BlockCoverable[TileExtractor] with BreakableInventoryBlock with BlockGuiWrenchable {
