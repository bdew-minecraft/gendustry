...
object BlockTransposer extends Block(Material.rock) with HasTE[TileTransposer] with BlockCoverable[TileTransposer] with BlockGuiWrenchable with BlockTooltip with BlockKeepData {
