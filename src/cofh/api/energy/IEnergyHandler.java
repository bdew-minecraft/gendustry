/*
 * This file belongs to CoFHLib and is here temporarily, untill i switch to use @API interface stripping
...
public interface IEnergyHandler {
     ...
     * @param maxReceive Maximum amount of energy to received.
     ...
     *
     * @param from       Orientation the energy is extracted to.
