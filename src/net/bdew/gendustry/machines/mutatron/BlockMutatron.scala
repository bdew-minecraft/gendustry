...
class BlockMutatron(id: Int) extends Block(id, Material.rock) with HasTE[TileMutatron] with BlockCoverable[TileMutatron] with BreakableInventoryBlock with BlockGuiWrenchable {
