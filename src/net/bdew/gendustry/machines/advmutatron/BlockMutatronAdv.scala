...
object BlockMutatronAdv extends BaseMachineBlock("mutatron_advanced") with HasTE[TileMutatronAdv] with BlockCoverable with BlockGuiWrenchable with BlockTooltip with BlockKeepData {
