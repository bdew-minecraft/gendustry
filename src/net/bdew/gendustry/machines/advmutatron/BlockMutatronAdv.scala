...
object BlockMutatronAdv extends BaseMachineBlock("MutatronAdv") with HasTE[TileMutatronAdv] with BlockCoverable with BlockGuiWrenchable with BlockTooltip with BlockKeepData {
